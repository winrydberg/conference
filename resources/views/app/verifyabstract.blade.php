        ...
        <div class="col-md-8">
            ...
            <div id="wizard_container" style="margin-bottom: 50px; display:flex: align-items:center; justify-content:center;">
                   ...
                   <div class="col-md-8" style="margin: 0 auto; padding-top: 50px; margin">
                    ...
                    <hr />
                    <h3 class="main_question">Only Two(2) Steps Required to Submit An Abstract</h3>
                    <ul>
                        <li>1. Enter your email in the above form to receive abstract submission link</li>
                        <br />
                        <li>2. Follow the link from your email & complete the abstract submission form</li>
                        <br />
