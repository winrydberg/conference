          ...
          <div class="box box-default">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                ...
                <form method="POST" id="editConference" action="#">
                    {{csrf_field()}}
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input class="form-control required" value="{{$conference?->title}}"  name="title" id="title"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input  class="form-control required"  value="{{$conference?->venue}}" name="venue" id="venue"/>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" id="usernamecont">
                        ...
                        <textarea class="form-control required"  rows="5" name="description" id="description">{{$conference?->description}}</textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input type="date"  class="form-control required" value="{{$conference?->startdate}}" name="startdate" id="startdate"/>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                    ...
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input type="time" class="form-control required" value="{{$conference?->starttime}}"  name="starttime" id="starttime"/>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input type="date" class="form-control"  value="{{$conference?->reg_startdate}}" name="reg_startdate" id="reg_startdate"/>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group" id="usernamecont">
                        ...
                        <input type="date" class="form-control"  value="{{$conference?->reg_enddate}}" name="reg_enddate" id="reg_enddate"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group" >
                        ...
                        @if($conference->brochure != null)
                            <p style="color:red; font-weight:bold;"><i class="fa fa-file"></i>{{$conference->brochure}}</p>
                        @endif
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        @if($abstract != null) 
                        <p style="color:red; font-weight:bold;"><i class="fa fa-file"></i>{{$abstract->file}}</p>
                        @endif
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" id="usernamecont">
                        ...
                        <textarea class="form-control required" rows="5" name="benefits" id="benefits">{{$conference?->benefits}}</textarea>
                      </div>
                    </div>
                  </div>
                  <br/>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" id="usernamecont">
                        ...
                        <textarea class="form-control required" rows="5" name="organizers" id="organizers">{{$conference?->organizers}}</textarea>
                      </div>
                    </div>
                  </div>
                 ...
                 <br />
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group" >
                        ...
                        <select class="form-control required" name="require_payment" id="require_payment">
                          <option value="1" {{$conference?->require_payment =="1" ? 'selected="selected"' : ''}}>Registration Require Payment</option>
                          <option value="0" {{$conference?->require_payment =="0" ? 'selected="selected"' : ''}}>Payment Not Required</option>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="form-group" >
                        ...
                        <select class="form-control select2" multiple="multiple" name="payment_methods[]" id="payment_methods">
                            <?php 
                                ...
                                try{
                                $paymethods =  json_decode($conference->payment_methods);
                          ...
                          @foreach($paymodes as $p)
                            <option value="{{$p->id}}" {{in_array($p->id, $paymethods)?'selected="selected"':''}}>{{$p->name}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-5" id="bankaccountcon" style="display:none;">
                      <div class="form-group" >
                        ...
                        <textarea class="form-control required accinfo" name="accinfo" id="accinfo">{{$conference?->bankinfo}}</textarea>
                  ...
                  <div id="payment">
                    @foreach($conference?->payment_categories as $c)
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" >
                          <label for="name">Category <span style="color:red;">*</span></label>
                          <input type="text"  value="{{$c->name}}" class="form-control required" name="category[]"/>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <select class="form-control required" name="currency[]" id="currency">
                            <option value="GHS" {{$c->currency == 'GHS' ? 'selected="selected"' : ''}}>GHS</option>
                            <option value="USD" {{$c->currency == 'USD' ? 'selected="selected"' : ''}}>USD</option>
                          </select> 
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group" >
                          ...
                          <input type="number" value="{{$c->amount}}" class="form-control required" name="amount[]" />
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" >
                          ...
                          <input type="text" value="{{$s->name}}"  class="form-control" name="name[]"/>
                          <small>Eg. UG</small>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group" >
                          ...
                          <input type="file" id="0" onchange="sponsor_logopath(this)" class="form-control" name="logo[]" />
                          <p style="color:red; font-weight:bold"><i class="fa fa-file"></i> {{$s->logo}}</p>
                        </div>
                      </div>

                      <div class="col-md-3" id="previewcon_0">
                        <img src="{{asset('storage/logos/'.$s->logo)}}" class="img-responsive" style="height: 100px; width: 100px;" alt="sponsor" />
                      </div>
                    </div>
                    @endforeach
                  </div>
...
<script>
    ...
    $('#editConference').submit(function(event){
        event.preventDefault();
        
        for (var i in CKEDITOR.instances) {
            CKEDITOR.instances[i].updateElement();
        }
        var data = new FormData($("#editConference")[0]);
        var title = 'Editing Conference';

        var form = $("#editConference");
